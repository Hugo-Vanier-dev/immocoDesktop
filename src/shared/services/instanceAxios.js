...
instance.interceptors.response.use(function (config) {
    console.log(Date.now() > parseInt(JSON.parse(localStorage.getItem('refresh'))) && Date.now() < parseInt(JSON.parse(localStorage.getItem('tokenLifetime'))));
    console.log(Date.now() > parseInt(JSON.parse(localStorage.getItem('tokenLifetime'))))
